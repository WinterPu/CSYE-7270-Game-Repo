...
public class Player : MonoBehaviour
{
    ...
    /// </summary>
    ///
    public int numGrenade = 1;
    public float firingAngle = 45.0f;
    public float throwForceScale = 1.3f;
    public GameObject grenade;
    public Transform tThrowingPoint;
    ...
    /// <summary>
    /// Ref: https://forum.unity.com/threads/throw-an-object-along-a-parabola.158855/
    /// </summary>
    /// <returns></returns>
    public void ThrowGrenade()
    {
        if (numGrenade > 0)
        {
            GameObject objGrenade = Instantiate(grenade, tThrowingPoint.position,Quaternion.identity);
            rbGrenade = objGrenade.gameObject.GetComponent<Rigidbody2D>();
            Vector2 force = new Vector2(1f, 1f) * firingAngle * throwForceScale;
    ...
    public int GetAvailableGrenadeNum()
    {
        return numGrenade;
    }
